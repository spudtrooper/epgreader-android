...
public class ImageDownloader {
  ...
  private void forceDownload(String url, ImageView imageView) {
    ...
    if (cancelPotentialDownload(url, imageView)) {
      ...
      case NO_DOWNLOADED_DRAWABLE:
        ...
        BitmapDownloaderTask task = new BitmapDownloaderTask(this, imageView);
        task.execute(url);
        break;

      case CORRECT:
        task = new BitmapDownloaderTask(this, imageView);
  ...
  public static Bitmap downloadBitmap(String url, Mode mode) {
  ...
  private class BitmapDownloaderTask extends AsyncTask<String, Void, Bitmap> {
    ...
    protected void onPostExecute(Bitmap bitmap) {
      ...
      this.imageDownloader.addBitmapToCache(url, bitmap);
      ...
      if (imageViewReference != null) {
        ...
        if ((this == bitmapDownloaderTask) || (this.imageDownloader.mode != Mode.CORRECT)) {
          imageView.setImageBitmap(bitmap);
        }
      }
    }
